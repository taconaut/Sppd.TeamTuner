            ...
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.NEUTRAL_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.COMMON_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.MELEE_ID),
                                    ManaCost = 4
                                });
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.NEUTRAL_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.RARE_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.RANGED_ID),
                                    ManaCost = 4
                                });
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.NEUTRAL_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.EPIC_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.MELEE_ID),
                                    ManaCost = 3
                                });
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.NEUTRAL_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.LEGENDARY_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.RANGED_ID),
                                    ManaCost = 6
                                });
            ...
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.SCIFI_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.COMMON_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.RANGED_ID),
                                    ManaCost = 3
            ...
            _cardRepository.Add(new Card
                                {
                                    ...
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.EPIC_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.TANK_ID),
                                    ManaCost = 5
                                });
            _cardRepository.Add(new Card
                                {
            ...
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.SCIFI_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.COMMON_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.SPELL_ID),
                                    ManaCost = 3
                                });
            ...
            _cardRepository.Add(new Card
                                {
                                    ...
                                    ThemeId = Guid.Parse(CoreDataConstants.Theme.FANTASY_ID),
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.COMMON_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.RANGED_ID),
                                    ManaCost = 3
            ...
            _cardRepository.Add(new Card
                                {
                                    ...
                                    RarityId = Guid.Parse(CoreDataConstants.Rarity.RARE_ID),
                                    TypeId = Guid.Parse(CoreDataConstants.CardType.CHARACTER_ID),
                                    CharacterTypeId = Guid.Parse(CoreDataConstants.CharacterType.ASSASSIN_ID),
                                    ManaCost = 3
                                });
            _cardRepository.Add(new Card
                                {
