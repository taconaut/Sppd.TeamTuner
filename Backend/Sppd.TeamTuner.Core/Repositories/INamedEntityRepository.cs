...
namespace Sppd.TeamTuner.Core.Repositories
{
        ...
        where TEntity : NamedEntity
    {
        ...
        /// <returns>All <see cref="NamedEntity" /> containing <see cref="containName" /> in their name.</returns>
        Task<IEnumerable<TEntity>> SearchByNameAsync(string containName, IEnumerable<string> includeProperties = null);
    }
}